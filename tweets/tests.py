...
class TweetTestCase(TestCase):
    def setUp(self):
        self.user = User.objects.create_user(username='xyz', password='somepassword')
        ...
        Tweet.objects.create(content='my forth tweet', user=self.user)
        self.currentCount = Tweet.objects.all().count()
    
    def test_tweet_created(self):
        tweet_obj = Tweet.objects.create(content='my fifth tweet', user=self.user)
